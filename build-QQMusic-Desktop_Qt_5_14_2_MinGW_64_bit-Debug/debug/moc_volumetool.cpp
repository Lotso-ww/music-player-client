...
QT_MOC_LITERAL(1, 11, 10), // "setSilence"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 14) // "setMusicVolume"

    },
    "VolumeTool\0setSilence\0\0setMusicVolume"
};
...
void VolumeTool::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setSilence((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->setMusicVolume((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VolumeTool::setSilence)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VolumeTool::setMusicVolume)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void VolumeTool::setMusicVolume(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
