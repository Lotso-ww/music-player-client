...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RecBox_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RecBox_t qt_meta_stringdata_RecBox = {
    {
QT_MOC_LITERAL(0, 0, 6), // "RecBox"
QT_MOC_LITERAL(1, 7, 17), // "on_btDown_clicked"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 15) // "on_btUp_clicked"

    },
    "RecBox\0on_btDown_clicked\0\0on_btUp_clicked"
};
...
void RecBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_btDown_clicked(); break;
        case 1: _t->on_btUp_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject RecBox::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_RecBox.data,
    qt_meta_data_RecBox,
    qt_static_metacall,
    nullptr,
    nullptr
