...
#include <memory>
#include "../../QQMusic/musicscanner.h"
...
QT_MOC_LITERAL(3, 23, 7), // "scanned"
QT_MOC_LITERAL(4, 31, 5), // "total"
QT_MOC_LITERAL(5, 37, 4), // "path"
QT_MOC_LITERAL(6, 42, 8), // "finished"
QT_MOC_LITERAL(7, 51, 21), // "QVector<ScannedMusic>"
QT_MOC_LITERAL(8, 73, 5), // "items"
QT_MOC_LITERAL(9, 79, 10), // "duplicates"
QT_MOC_LITERAL(10, 90, 8), // "failures"
QT_MOC_LITERAL(11, 99, 9), // "cancelled"
QT_MOC_LITERAL(12, 109, 7) // "runScan"

    },
    "MusicScanner\0progress\0\0scanned\0total\0"
    "path\0finished\0QVector<ScannedMusic>\0"
    "items\0duplicates\0failures\0cancelled\0"
    "runScan"
};
...
static const uint qt_meta_data_MusicScanner[] = {
 ...
 // signals: parameters
    ...
    QMetaType::Void, 0x80000000 | 7, QMetaType::QStringList, QMetaType::QStringList,    8,    9,   10,
    QMetaType::Void,
...
void MusicScanner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->finished((*reinterpret_cast< const QVector<ScannedMusic>(*)>(_a[1])),(*reinterpret_cast< const QStringList(*)>(_a[2])),(*reinterpret_cast< const QStringList(*)>(_a[3]))); break;
        case 2: _t->cancelled(); break;
        case 3: _t->runScan(); break;
        default: ;
        }
        ...
        {
            using _t = void (MusicScanner::*)(int , int , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MusicScanner::progress)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MusicScanner::*)(const QVector<ScannedMusic> & , const QStringList & , const QStringList & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MusicScanner::finished)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MusicScanner::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MusicScanner::cancelled)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void MusicScanner::progress(int _t1, int _t2, const QString & _t3)
{
...
// SIGNAL 1
void MusicScanner::finished(const QVector<ScannedMusic> & _t1, const QStringList & _t2, const QStringList & _t3)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t3))) };
